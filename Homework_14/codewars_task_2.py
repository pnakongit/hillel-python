...
def increment_string(strng):
    ...
    alpha_str = strng.rstrip('1234567890')
    digit_str = strng[len(alpha_str):]

    digit_str_plus_one = str(int(digit_str)+1).zfill(len(digit_str))

    return alpha_str + digit_str_plus_one
