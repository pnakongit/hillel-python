...
def narcissistic(value):
    list_numbers = list(str(value))
    list_degree_numbers = list(map(lambda x: int(x) ** len(list_numbers), list_numbers))
    return True if sum(list_degree_numbers) == value else False
